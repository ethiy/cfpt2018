  ...
  \begin{tikzpicture}
    ...
    \path[mindmap, concept color=black!50, text=black]
      ...
      child[concept color=blue, text=white, grow=0]{
      	...
      	child[concept color=black!50!green, grow=270, text=white]{
      		node[concept]{\textsc{Valid}}
      	}
      	child[concept color=red, grow=30]{
      		node[concept]{\textsc{Errors}}
      		child[concept color=purple, text=white, grow=90]
      		{
      ...
      \path (input.west) + (-3, 4) node[circle, fill, color=orange, minimum size=2cm, anchor=east] (1) {};
      ...
      \path (input.west) + (-3, 1.7) node[circle, fill, color=black!50!green, minimum size=1.8cm, anchor=east] (2) {};
      ...
      \path (input.west) + (-3, -.4) node[circle, fill, color=purple, minimum size=1.6cm, anchor=east] (3) {};
      \path (3.east) + (1.5, 0) node[text=black, align=left] {Error Family\\\textit{depth: }$2$};

      \path (input.west) + (-3, -2.3) node[circle, fill, color=blue!70!yellow, minimum size=1.4cm, anchor=east] (4) {};
      \path (4.east) + (1.5, 0) node[text=black, align=left] {Sub Errors\\\textit{depth:} $3$};

      \path (4.east) + (2.75, -.75) node (8) {};
      \path[rounded corners, draw=black!50, dashed] (1.west) + (-.25, 1.5) rectangle (8);
      \path (1.west) + (1, 1.5) node[fill=white, text width= 1.5cm] (legend) {\textsc{Legend}};
